...
export default async function VardhiInvoicePrintPage({ params }: Props) {
    const { estimationId } = await params;

    const invoice = await getInvoiceByEstimation(estimationId);
    if (!invoice) {
        return notFound();
    }
        ...
        <div className="bg-white min-h-screen p-0 md:p-8 font-serif text-slate-900 print:p-0">
            <div className="max-w-[21cm] mx-auto border-2 border-slate-900 p-8 shadow-2xl print:shadow-none print:border-none">
                ...
                <div className="text-center mb-8 border-b-2 border-slate-900 pb-4">
                    ...
                    <p className="text-sm font-bold opacity-60">(Duplicate for Transporter / Original for Recipient)</p>
                </div>
                    ...
                    <div className="p-4 border-r-2 border-slate-900 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="text-[11px] space-y-1">
                                ...
                                <p><span className="font-bold">IFSC:</span> <span className="font-mono">{branch_ifsc}</span></p>
            ...
            <div className="fixed bottom-8 right-8 print:hidden flex gap-4">
                ...
                <Button size="lg" asChild className="shadow-lg bg-blue-600 hover:bg-blue-700">
                    <Link href={`/bill-generated/invoice/${estimationId}`}>
                        Back to Edit
                    </Link>
                </Button>
            </div>
